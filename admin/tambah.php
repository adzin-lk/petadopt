...
<head>
    ...
    <title>Tambah Hewan Baru - PetAdopt Admin</title>
    ...
    <main class="flex-1 w-full bg-[#FAF8F5]">
        ...
        <div class="w-full p-6 lg:p-10">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 tracking-tight">Tambah Hewan Baru</h2>
                    <p class="text-gray-500 mt-2 text-sm md:text-base">Masukkan profil hewan peliharaan yang siap diadopsi ke dalam sistem.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-6 lg:p-8">
                    <form action="proses.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <!-- Input hidden sesuai instruksi -->
                        <input type="hidden" name="aksi" value="tambah">
                        
                        <!-- Nama Hewan -->
                        <div>
                            <label for="nama" class="block text-sm font-semibold text-gray-700 mb-2">Nama Hewan</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select id="spesies" name="jenis_hewan" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#1E3F20] focus:ring-2 focus:ring-[#1E3F20]/20 transition-all outline-none bg-white">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#1E3F20] focus:ring-2 focus:ring-[#1E3F20]/20 transition-all outline-none text-gray-600">
                            </div>

                            <!-- Tanggal Masuk -->
                            <div>
                                <label for="tanggal_masuk" class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Masuk</label>
                                <input type="date" id="tanggal_masuk" name="tanggal_masuk" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#1E3F20] focus:ring-2 focus:ring-[#1E3F20]/20 transition-all outline-none text-gray-600">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#1E3F20] focus:ring-2 focus:ring-[#1E3F20]/20 transition-all outline-none resize-y" placeholder="Ceritakan kepribadian hewan ini..."></textarea>
                        </div>

                        <!-- Foto Hewan -->
                        <div>
                            <label for="foto" class="block text-sm font-semibold text-gray-700 mb-2">Foto Hewan</label>
                            ...
                            <p class="text-xs text-gray-400 mt-2">Maksimal 2MB. Format diizinkan: JPG, JPEG, PNG.</p>
                        </div>
